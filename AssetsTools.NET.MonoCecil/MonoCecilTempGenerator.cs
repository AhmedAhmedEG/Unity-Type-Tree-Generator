...
namespace AssetsTools.NET.Extra
{
    public class MonoCecilTempGenerator : IMonoBehaviourTemplateGenerator
    {
        ...
        public MonoCecilTempGenerator(string managedPath) { this.managedPath = managedPath; }

        public void Dispose()
        {
            foreach (AssemblyDefinition assembly in loadedAssemblies.Values) assembly.Dispose();
        ...
        public AssemblyDefinition GetAssemblyWithDependencies(string path)
        {
            ...
            if (loadedAssemblies.ContainsKey(assemblyName)) return loadedAssemblies[assemblyName];
        ...
        private void RecursiveTypeLoad(ModuleDefinition module, string nameSpace, string typeName, List<AssetTypeTemplateField> attf, int availableDepth)
        {
            ...
            if (typeName.Contains('/'))
            {
                ...
                {
                    typeRef = new TypeReference("", types[i], module, module) { DeclaringType = type };
